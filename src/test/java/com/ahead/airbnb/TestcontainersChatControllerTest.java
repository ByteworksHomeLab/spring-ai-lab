...
class TestcontainersChatControllerTest {

	private static final Logger logger = LoggerFactory.getLogger(TestcontainersChatControllerTest.class);
	...
	void verifyWhichTestcontainersModulesAreAvailableInJava() {
		...
		var answer = restTemplate.getForObject("/chat?message={question}", String.class, question);
		var reference = """
